    ...
    else
    {
        ...
        if($rand == $otp)
        {
            ...
            else
            {
                ...
                $timestamp = date('Y-m-d H:i:s'); // future: probably make one for join_date as well

                $insert="INSERT INTO `user` VALUES (NULL,'$first_name','$last_name','$hash_password','$email','$phone',1,2, 'defaultprofile.png', '$timestamp')";
