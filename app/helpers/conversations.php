...
function getConversation($user_id, $connect) {
    ...
    **/
    $select_conversation = "SELECT * FROM conversations
        ...
        **/
        ...
        foreach ($conversations as $conversation) {
            if ($conversation['user_1'] == $user_id) {
                $sql2  = "SELECT * FROM user WHERE user_id=" . $conversation['user_2'];
            } else {
                $sql2  = "SELECT * FROM user WHERE user_id=" . $conversation['user_1'];
            }
